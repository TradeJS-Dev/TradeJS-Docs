---
title: Как писать свои индикаторы на TypeScript
description: 'Создайте плагин индикатора на TypeScript, зарегистрируйте его в tradejs.config.ts, рассчитайте значения по рыночным данным и выведите результат на график TradeJS.'
---

Создайте плагин индиктора на TypeScript, зарегистрируйте его в `tradejs.config.ts` и
добавьте его значения на график TradeJS.

Пользовательские индикторы TradeJS оформляются как плагины на TypeScript.
Отдельные плагины индикторов Pine пока не поддерживаются. Pine можно использовать в
модулях стратегий.
