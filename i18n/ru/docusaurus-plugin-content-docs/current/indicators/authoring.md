...
В этой статье показано, как добавить свой индикатор на TypeScript и вывести его в графике TradeJS.

Пользовательские индикаторы TradeJS создаются как TypeScript plugins. Самостоятельные Pine indicator plugins пока не поддерживаются; поддержка Pine ограничена strategy modules.
