...
Командная строка TradeJS содержит команды для локальных сервисов,
диагностики, обслуживания данных и быстрых проверок.

## Локальная инфраструктура для разработки

Создайте локальный Compose-файл. Команду нужно выполнить один раз:
