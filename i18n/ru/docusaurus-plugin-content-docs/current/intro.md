...
Совместимость с Pine-backed стратегиями, AI/ML enrichment, grid search, Telegram-уведомления и опциональное приложение расширяют этот основной процесс.

## Публичные пакеты

- `@tradejs/core` - browser-safe API для разработки, config helpers, общие indicator/math/time helpers
- `@tradejs/node` - Node runtime для стратегий, бэктестов, Pine strategy loading, connector/plugin registries
...
- [Лицензирование](./introduction/licensing)
