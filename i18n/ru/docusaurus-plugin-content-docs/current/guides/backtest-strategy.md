---
sidebar_label: Бэктест стратегии
title: Как провести бэктест торговой стратегии на TypeScript
description: 'Запустите торговую стратегию на TypeScript по историческим свечам через TradeJS CLI, изучите метрики и сравните конфигурации при одинаковых допущениях.'
---
