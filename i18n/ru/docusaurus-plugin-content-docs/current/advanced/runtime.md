...
редактирования, аналитику стратегий, просадку, ордера и управление паузой. На
runtime-графике отмечаются зафиксированные смены ревизии, а действие
**Revisions** показывает текущую ревизию и изменения, найденные в выбранном
окне сделок. Доходность, доля успешных сделок, просадка, время в позиции и
