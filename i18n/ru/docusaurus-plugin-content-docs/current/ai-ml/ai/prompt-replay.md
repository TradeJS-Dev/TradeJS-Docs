...
- поведение `tp / fp / tn / fn` для AI approval против исторического результата
...
- `tp / fp / tn / fn` для approval против исторического результата
