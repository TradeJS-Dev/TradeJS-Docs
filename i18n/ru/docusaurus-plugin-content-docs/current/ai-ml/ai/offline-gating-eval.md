---
title: Оффлайн-оценка ИИ-фильтрации
---

Перед изменением AI-gating логики оцените эффект оффлайн, без влияния на live-исполнение.

Если сначала нужен общий workflow о том, как бэктест превращается в replayable AI dataset, начните со статьи [Replay промптов из бэктестов](./prompt-replay).
