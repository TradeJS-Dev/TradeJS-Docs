---
sidebar_label: Runtime-мост
title: Реализация runtime-моста Pine-стратегии
description: 'Запустите Pine Script внутри TradeJS, прочитайте plots, примените правила инвалидации и верните решения стратегии.'
---

Это глава 3 [пошагового руководства по Pine-стратегии](./pine-strategy-step-by-step). Здесь Pine evaluator подключается к контракту стратегии TradeJS.
...
**Назад:** [постройте figures для входа](./pine-strategy-figures). **Далее:** [зарегистрируйте и протестируйте стратегию](./pine-strategy-registration-and-backtest).
