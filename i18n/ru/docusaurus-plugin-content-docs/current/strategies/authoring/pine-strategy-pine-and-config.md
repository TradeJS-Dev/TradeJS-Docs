---
sidebar_label: Pine и конфиг
title: Создание модуля, Pine-исходника и конфига стратегии
description: 'Создайте модуль Pine-стратегии TradeJS, добавьте Pine Script и определите типизированный конфиг для runtime и бэктеста.'
---

Это глава 1 [пошагового руководства по Pine-стратегии](./pine-strategy-step-by-step). Здесь создаются граница модуля, Pine-исходник и типизированный конфиг для следующих этапов.
...
**Далее:** [постройте figures для входа](./pine-strategy-figures).
