---
sidebar_label: Пошаговое создание стратегии на Pine Script
title: 'Стратегия Pine Script в TradeJS: добавление и тест'
description: 'Добавьте стратегию Pine Script в TradeJS как зарегистрированный модуль с runtime-мостом, конфигурацией, фигурами, адаптерами и историческим бэктестом.'
---
