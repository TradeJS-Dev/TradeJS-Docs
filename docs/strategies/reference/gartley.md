...
| Risk | `FEE_PERCENT`, `MAX_LOSS_VALUE`, `GARTLEY_TARGET_XA_FIB_PCT`, `GARTLEY_STOP_XA_FIB_PCT`, `GARTLEY_EXIT_ON_OPPOSITE_PATTERN` | Account for fees, size positions, project the target and stop from XA, and choose the opposite-pattern exit. |
