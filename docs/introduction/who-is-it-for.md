...
If you are new to trading systems, start with [What TradeJS is not](./what-tradejs-is-not) and [Backtesting caveats](../limitations/backtesting-caveats) before using any automation path.
